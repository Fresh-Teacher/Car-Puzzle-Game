(function(cjs, an) {
    ...
    (lib._12_auto = function() {
        this.spriteSheet = ss["12_puzzle_auto_atlas_"];
        this.gotoAndStop(0);
    }).prototype = p = new cjs.Sprite();



    (lib._12_auto_p1 = function() {
        this.spriteSheet = ss["12_puzzle_auto_atlas_"];
        this.gotoAndStop(1);
    }).prototype = p = new cjs.Sprite();
    ...
    (lib.complete_puzzle = function(mode, startPosition, loop) {
        ...
        // Capa_2
        this.instance = new lib._12_auto();
    ...
    (lib.piece4 = function(mode, startPosition, loop) {
        ...
        // Layer 3
        this.instance = new lib._12_auto_p4();
        this.instance.parent = this;
    ...
    (lib.piece3 = function(mode, startPosition, loop) {
        ...
        // Layer 2
        this.instance = new lib._12_auto_p3();
        this.instance.parent = this;
    ...
    (lib.piece2 = function(mode, startPosition, loop) {
        ...
        // Layer 4
        this.instance = new lib._12_auto_p2();
        this.instance.parent = this;
    ...
    (lib.piece1 = function(mode, startPosition, loop) {
        ...
        // Layer 4
        this.instance = new lib._12_auto_p1();
        this.instance.parent = this;
    ...
    // stage content:
    (lib._12puzzleauto = function(mode, startPosition, loop) {
        this.initialize(mode, startPosition, loop, {});
    ...
    lib.properties = {
        ...
        opacity: 1.00,
        manifest: [{
                src: "images/12_puzzle_auto_atlas_.png",
                id: "12_puzzle_auto_atlas_"
            },
            {
